        ...
        <ul class="nav flex-column p-3">
            ...
            <li class="nav-item mb-2">
               ...
               {{ request()->routeIs('superadmin.dashboard') ? 'active' : 'text-dark' }}">
                    <iconify-icon icon="mdi-light:view-dashboard" width="22" height="35"></iconify-icon>
                    <span>Dashboard</span>
                </a>
            </li>  
            ...
            <li class="nav-item mb-2">
               ...
               {{ request()->routeIs('superadmin.users.index') ? 'active' : 'text-dark' }}">
                    <iconify-icon icon="mdi-light:account" width="22" height="35"></iconify-icon>
            ...
            <li class="nav-item mb-2">
               ...
               {{ request()->routeIs('superadmin.yearBooks.index') ? 'active' : 'text-dark' }}">
                    <iconify-icon icon="material-symbols:date-range-outline" width="22" height="35"></iconify-icon>
                    <span>Year Book</span>
                </a>
            </li>
